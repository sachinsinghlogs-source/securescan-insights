...
import { Trash2, FileText, Shield, CheckCircle, XCircle, AlertTriangle, ChevronDown, ChevronUp } from 'lucide-react';
  ...
  return (
    <div className="space-y-4">
      {reports.map((report) => {
        ...
        const remediation = (report.remediation_priority || []) as Array<{ title: string; severity: string; effort: string; impact: string; category: string }>;
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  {Object.entries(compliance).map(([name, val]) => {
                    ...
                    return (
                      <Badge key={name} variant="outline" className={`text-[10px] gap-1 ${complianceColors[val.status] || ''}`}>
                  ...
                  <div className="p-3 rounded-lg bg-muted/50 border border-border">
                    ...
                    <div className="w-full bg-muted rounded-full h-2 mt-2">
                      <div
                        ...
                        style={{ width: `${report.attack_surface_score}%` }}
                      />
                    </div>
                  </div>
                ...
                {remediation.length > 0 && (
                  <div>
                    ...
                    <div className="space-y-1.5 max-h-60 overflow-y-auto">
                      {remediation.slice(0, 15).map((item, i) => (
